...
class FinanceCalculatorTest {
    ...
    fun testDifferentTypesInSimpleSum() {
        val op1 = Operation(10.2, Currency.RUB, null)
        val op2 = Operation(-10.2, Currency.RUB, null)
    ...
    fun testDifferentCurrenciesInSimpleSum() {
        val op1 = Operation(0.01, Currency.USD, null)
        val op2 = Operation(-10.0, Currency.RUB, null)
    ...
    @Test
    fun testTotalSum() {
        val op1 = Operation(1.0,Currency.USD, null)
        val op2 = Operation(2.0, Currency.USD, null)
        val op3 = Operation(-100.0, Currency.USD, null)
        val op4 = Operation(-3.0, Currency.USD, null)
    ...
    fun testTotalCurrency() {
        val op1 = Operation(1.0, Currency.RUB, null)
        val op2 = Operation(1.0, Currency.USD, null)
        val op3 = Operation(1.0, Currency.RUB, null)
    ...
    fun testComplicityCalculation() {
        val op1 = Operation(10.0, Currency.RUB, null)
        val op2 = Operation(1.0, Currency.USD, null)
        val op3 = Operation(-11.0, Currency.RUB, null)
        val op4 = Operation(-1.0, Currency.USD, null)

        val result = arrayListOf(op1, op2, op3, op4).total(10f, currency = Currency.RUB)
        val correct = Operation(-1.0, Currency.RUB, null)
